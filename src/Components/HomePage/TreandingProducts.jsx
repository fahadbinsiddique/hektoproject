    ...
    <section>
      ...
      <div className="container mx-auto pb-16 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Product Card */}
          {[boximage, image1170png, image31png, image321png].map((image, index) => (
            <div
              key={index}
              className="h-[350px] border-[10px] shadow-2xl border-white bg-white"
            >
              ...
              <div className="flex gap-2 justify-center items-center pt-1">
                ...
                <p className="text-[12px] font-josef text-gray-400 line-through">$42.00</p>
              </div>
            </div>
          ))}
        </div>
            ...
            {[1, 2, 3].map((_, index) => (
              ...
              >
                <div className="w-[80px] h-[80px] flex justify-center items-center bg-white">
                  <img src={image30png} alt={`Product Image ${index}`} />
                </div>
                <div>
